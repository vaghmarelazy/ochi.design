...
function Footer() {
  return (
    <div className="relative w-full - h-[120vh] bg-[#18181B] rounded-l-3xl">
      <div className="w-full h-screen absolute bottom-10 pt-16 flex">
        <div className="w-1/2 relative">
          {["EYE-", "OPENING"].map((item, index) => (
            <span className="thead px-10 text-[9vw] leading-[.75]">
              {item}
              <br />
            </span>
          ))}
        ...
        <div className="w-1/2 flex flex-col relative">
          <div className="thead text-[9vw] w-full leading-[.75]">
            PRESENTATIONS
          </div>
          <div className="mt-10">
          ...
          <div className="shead mt-10 relative flex justify-between text-zinc-600">
            <span>© ochi design 2024. Legal Terms</span>
            <span className="px-10">Website by Obys</span>
          </div>
        </div>
      </div>
    </div>
