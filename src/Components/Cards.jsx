...
function Cards() {
  ...
  return (
    <div className="px-10 w-full h-screen flex gap-4">
      <div className="w-1/2 bg-[#004D43] h-[55vh] rounded-xl relative">
        <div className="w-full h-[55vh] absolute flex items-center justify-center">
          <svg
            width="122"
            height="80"
            viewBox="0 0 72 30"
        ...
        <button className="absolute w-1/2 h-[10vh] left-0 bottom-0">
          <h1 className="text-[#CDEA68] absolute left-5 bottom-5 py-2 px-4 border-[#CDEA68] border-2 rounded-full">
            &copy;2019-2022
          </h1>
        </button>
      </div>
      <div className="w-1/2  h-full rounded-xl flex gap-4 relative">
        <div className="relative w-1/2 bg-[#212121] h-[55vh] rounded-xl flex items-center justify-center">
          <img
            src="https://ochi.design/wp-content/uploads/2022/04/logo002.svg"
            alt=""
          />
          <button className="absolute  h-[10vh] left-0 bottom-0">
            <h1 className="text-[#ffffff] absolute left-5 bottom-5 py-2 px-4 border-[#ffffff] border-2 rounded-full whitespace-nowrap">
